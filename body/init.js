document.addEventListener('DOMContentLoaded', function() {
    ...
    img.style = "width:80px; position:fixed; bottom:0; left:0;";
    img.alt = "2048";
    a.appendChild(img);
    ...
    gameButton.className = "startGameButton";
    gameButton.innerHTML = `<button id="startGameButton">开始游戏</button>`;
    document.body.appendChild(gameButton);
    document.getElementById('startGameButton').style.position = 'fixed';
    document.getElementById('startGameButton').style.top = '40px';
    document.getElementById('startGameButton').style.right = '413px';
    document.getElementById('startGameButton').style.opacity = '0.5';
